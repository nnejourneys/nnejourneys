        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8 offset-lg-2"> 
               ...
               <p><small>Last updated: 19 January 2024</small></p>
              ...
              <ul>
                ...
                <li>Company (referred to as either 'the Company', 'We', 'Us' or 'Our' in this Agreement) refers to North by Northeast Journeys, #222, Mansiri House.</li>
                ...
                <li>Website refers to North by Northeast Journeys, accessible from https://nnejourneys.com/</li>
              ...
              <ul><li><strong>Necessary / Essential Cookies</strong></li><br></br>
                <p>Administered by: Us</p>
              <p>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
              </ul>
            
              <ul>
                <li><strong>Cookies Policy / Notice Acceptance Cookies</strong></li><br></br>
                <p>Type: Persistent Cookies</p>
                <p>Administered by: Us</p>
                <p>Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
              </ul>
              <ul>
                <li><strong>Functionality Cookies</strong></li><br></br>
                <p>Type: Persistent Cookies</p>
                <p>Administered by: Us</p>
